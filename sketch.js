...
var ball,ground,block1,block2,block3,block4,block5,block6,block7,block8,block9,block10,block11,block12,block13,block14,block15,block16,stone1,stone2,stone3,backgroundIMG,hex,stand1,stand2
var gameState="play"
var gameState="start"
var engine, world;
var ball
...
function setup() {
  ...
  rectMode(CENTER);
    ...
    stand1=new Ground(385,400,230,20)
    stand2=new Ground(700,300,230,20)
    ...
    block6=new Block2(360,195,30,40)
    block7=new Block2(390,195,30,40)
    block8=new Block2(420,195,30,40)
    block9=new Block3(390,155,30,40)
    block10=new Block4(300,275,30,40)
    block11=new Block4(330,275,30,40)
...
function draw() {
  ...
  textSize(50)
  fill("black")
  text("Drag the Hexagonal Stone and Release it,",80,80);
  text("to launch it towards the blocks",80,150)
